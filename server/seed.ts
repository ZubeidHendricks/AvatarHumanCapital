    ...
    await db.insert(whatsappMessages).values([
      {
        ...
        direction: "outbound",
        senderType: "ai",
        body: "Hello Sipho! Thank you for your interest in the Senior Backend Developer position at AHC - Human Capital. We were impressed by your profile. Would you be interested in scheduling an interview?",
        status: "delivered",
      ...
      },
      {
        ...
        direction: "outbound",
        senderType: "human",
        body: "Hi Lerato, this is the HR team at AHC - Human Capital. We need a few documents for your background check. Could you please send your proof of address?",
        status: "delivered",
