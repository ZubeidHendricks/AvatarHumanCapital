...
app.post("/api/public/interview-session/:token/video-session", async (req, res) => {
  try {
    ...
    const customGreeting = `Hello! I'm Charles Molapisi, the Group Chief Technology and Information Officer here at AHC. Thank you for making the time to speak with me today. I'm looking forward to learning more about you and discussing the ${jobRole} position. Before we dive in, how are you doing today?`;
