...
function generateInterviewPrompt(candidate: any, job: Job | null | undefined): string {
  ...
  let prompt = `You are an HR interviewer for AHC Human Capital conducting a screening interview for the ${jobTitle} position${department ? ` in the ${department} department` : ''}.
