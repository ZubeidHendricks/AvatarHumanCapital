...
const statusConfig: Record<string, { label: string; color: string; icon: React.ReactNode }> = {
  ...
  expired: { label: "Expired", color: "bg-orange-500/20 text-orange-600 dark:text-orange-400 border-orange-500/30", icon: <AlertCircle className="h-3 w-3" /> },
};
                          ...
                          <TableCell className="text-right">
                            <div className="flex items-center justify-end gap-1">
                              ...
                              <Button
                                variant="ghost"
                                size="icon"
                                className="h-8 w-8 text-muted-foreground hover:text-purple-600 dark:text-purple-400"
                    ...
                    <div className="bg-muted/50 p-3 rounded-lg">
                      <div className="flex items-center gap-2 mb-2">
                        {selectedDocument.aiVerification.verified ? (
                          ...
                          <Badge className="bg-orange-500/20 text-orange-600 dark:text-orange-400">Needs Review</Badge>
                        )}
