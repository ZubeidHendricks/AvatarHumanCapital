        ...
        <section className="py-24 border-t border-border bg-secondary">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto mb-10 text-lg">
              Join the future of human capital and operational management with AHC - Human Capital's intelligent advisory solutions.
            </p>
      ...
      <footer className="bg-[#1E3A5F] text-white py-12">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-white/50 text-sm">
                <li className="flex items-center gap-2"><Mail className="w-4 h-4" /> contact@ahc.com</li>
          ...
          <div className="border-t border-white/10 mt-12 pt-8 text-center text-sm text-white/30">
            © {new Date().getFullYear()} AHC - Human Capital. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
